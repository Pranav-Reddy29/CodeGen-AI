...
export const projectsAPI = {
  ...
  update: (projectId, updates) => apiRequest(`/projects/${projectId}`, { method: "PUT", body: JSON.stringify(updates) }),
...
export const aiAPI = {
  generateCode: (prompt, language, projectType) =>
    apiRequest("/generate", { method: "POST", body: JSON.stringify({ prompt, language, projectType }) }),
};
